...
import { createEpic, deleteEpic, getEpicsByKeyResult, updateEpic, updateEpicpriority, updateEpicStatus,getEpicById } from "../../controllers/Objectives/epic.controller.js";
const router=express.Router();
router.post("/key-results/:keyResultId",createEpic);
router.get("/epic/:id/detail", getEpicById);
